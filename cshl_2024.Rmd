...
By default, --pca extracts the top 20 principal components. But we can change the number of PCs by specifying in the commands. The following codes perform PCA and obtain the first 50 PCs.
...
## maybe need top 10 PCs

# calculate the cumulative sum of the percentage variance explained
cumsum(pve$pve)
#[1]   7.743514  14.022760  19.646525  25.135280  30.349309  35.262146  40.074294  44.818836  49.511040  54.183075
#[11]  58.843948  63.475603  68.081387  72.670111  77.241894  81.804549  86.363656  90.917741  95.465328 100.000000
...
pca <- read.table("./Data/PC/younameit.eigenvec"), col_names = FALSE)
