...
setwd("./Data/case_data")
mydir<-getwd()
```

The packages we will use in this notebook include: data.table, GEOquery (from Biocondector), GenABEL, qqman, png and QCGWAS. You will need to install these packages by yourself in R. The codes to install these packages are list below and are commented out with `#`.
...
# data_path=/path/to/bigcare-main/Data/case_data
