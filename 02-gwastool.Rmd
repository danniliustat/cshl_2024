...
```{r fig.cap='PC plot of genotype', out.width='150%', fig.asp=.5, fig.align='center'}
# R codes- run in R Console
...
```{r warning=F, message=F,fig.cap='PC plot of genotype, colored by case/control', out.width='150%', fig.asp=.5, fig.align='center'}
set.seed(123)
