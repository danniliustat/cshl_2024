...
**Note:** In order to run codes in this notebook, please make sure you have coloned the "cshl_2024" repository from GitHub and have RStudio installed on your laptop.
</span>
...
Before we can run any analysis, we need to set the working directory path in RStudio Console to the downloaded "cshl_2024" folder and load the necessary R packages. To setup the working directory, make sure you run the following codes in R Terminal.
